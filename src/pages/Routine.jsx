    ...
    <div className="routine-page">
      <div className="Scroll-image-header">
        ...
        <div className="images-nav">
          <button onClick={() => document.getElementById("img-1").scrollIntoView({ behavior: "smooth" })} className="nav"></button>
          <button onClick={() => document.getElementById("img-2").scrollIntoView({ behavior: "smooth" })} className="nav"></button>
          <button onClick={() => document.getElementById("img-3").scrollIntoView({ behavior: "smooth" })} className="nav"></button>
          <button onClick={() => document.getElementById("img-4").scrollIntoView({ behavior: "smooth" })} className="nav"></button>
        </div>
      </div>
