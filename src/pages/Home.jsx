...
import chris1 from "../assets/home_page/chris1.webp";
import chris2 from "../assets/home_page/chris2.jpg";
import david1 from "../assets/home_page/david1.jpg";
import david2 from "../assets/home_page/david2.webp";
      ...
      <div className="home-page-Welcome-header">
        ...
        <div className="image-left">
          ...
          <div className="Welcome-text-header1">
            ...
            <p className="text-welcome2">
              Start your day with a new<br></br> achievement!
            </p>
        ...
        <div className="image-right">
          ...
          <div className="Welcome-text-header2">
            <div className="welcome-text-2-header">
              <CgProfile color="white" className="image-right-profile" />
      ...
      <div className="home-page-content">
        ...
        <div className="home-page-content-bodybuilder">
          <img
            src={chris1}
            alt="img4-chris"
            className="home-page-bodybuilder"
          />
          <img
            src={chris2}
            alt="img5-chris"
        ...
        <div className="home-page-content-generalnews">
          <iframe
            ...
            src="https://www.youtube.com/embed/dT_KBtUILfg?si=LrnCxV6q24nG08e_"
          ...
          <iframe
            className="news-video"
            src="https://www.youtube.com/embed/ei-RTWKznPo?si=GTjw88nKLyoepMV7"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
